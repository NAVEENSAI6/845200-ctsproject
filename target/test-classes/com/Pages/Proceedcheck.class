...
public class Proceedcheck {
	...
	{
		driver.get("http://automationpractice.com/index.php"); // takes us to the homepage of the application
	...
	public void Screenshot() throws IOException
	{
		...
		FileUtils.copyFile(f, new File("D:\\Selenium\\eclipse\\Addtocart\\Screenshots\\Proceedtocheck.png"));
	}
}
